...
t = (0:length(fcg)-1)/fs;
figure(6)
title('FCG, ECG, CPS SIGNALS')
subplot(3,1,1),plot(t,fcg), xlim([1 4]),ylabel('FCG')
subplot(3,1,2),plot(t,ecg), xlim([1 4]),ylabel('ECG')
subplot(3,1,3),plot(t,cps), xlim([1 4]),ylabel('CPS')
xlabel('t')
